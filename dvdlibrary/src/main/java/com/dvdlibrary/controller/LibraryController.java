...
public class LibraryController {
    ...
    // Controls and executes program flow
    public void execute() {  
        int userChoice;
        do {
    ...
    // Errors in the service, i/o, data access, will call this to print the error to the screen 
    // calls the execute method to return the user to the menu
